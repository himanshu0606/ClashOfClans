...
def printMap(V):
    ...
    for stealth_arch in stealth_archers:
        ...
        map_matrix[a][b] = archColor(stealth_arch) + Fore.BLACK + 'ST'
        map_matrix[a+1][b] = archColor(stealth_arch) + Fore.BLACK + '  '
        map_matrix[a][b+1] = archColor(stealth_arch) + Fore.BLACK + 'EAL'
        map_matrix[a+1][b+1] = archColor(stealth_arch) + Fore.BLACK + 'TH'
    
    for healer in healers:
        a= 2*healer.position[0]
        b = 2*healer.position[1]
        map_matrix[a][b] = healerColor(healer) + Fore.BLACK + 'HE'
        map_matrix[a+1][b] = healerColor(healer) + Fore.BLACK + '  '
        map_matrix[a][b+1] = healerColor(healer) + Fore.BLACK + 'AL'
        map_matrix[a+1][b+1] = healerColor(healer) + Fore.BLACK + 'ER'
